...
func LoadConfig() error {
	...
	Conf = &BotConfig{
		...
		OwnerId:           getEnvInt64("OWNER_ID", "6848223695"),
		LoggerId:          getEnvInt64("LOGGER_ID", "-1001802598180"),
		...
		SupportGroup:      getEnvStr("SUPPORT_GROUP", "https://t.me/ArcChatz"),
		SupportChannel:    getEnvStr("SUPPORT_CHANNEL", "https://t.me/ArcUpdates"),
